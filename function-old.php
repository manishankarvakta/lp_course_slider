...
function slider_shotCode( $atts ){
    // echo getCourseThumbnail($co->ID)
    // echo $course->get_students_html();
...
function getCourse(){
    ...
    $sql = "SELECT * FROM `wp_posts` WHERE `post_type` = 'lp_course' AND `post_status` = 'publish'";
